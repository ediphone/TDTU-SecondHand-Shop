...
function Home() {
    ...
    const handleDeletePost = () => {
        ...
        body.append("postid", postid)
        body.append("email", email)
        postMethod('manager/home/post/delete', body)
            .then((res) => {
                setShowDelete(false);
                if (res) {
                    setPosts(res)
                ...
                {posts.length >0 && posts.map((item, index) => (
                    <div className={cx('posts')} key={index}>
                        <div className={cx('posts__header')}>
                            <User email={item.emailShop} timeCreate={item.timeCreated} link='/manager/user_information/' />
                            <div className={cx('posts__header-right')}>
                                ...
                                <div className={cx('header__right-button')} >
                                    <div 
                                        className={cx('posts__button-link','text-danger')}
                            ...
                            <div className={cx('wrapper')}>
                                ...
                                <div className={cx('wrapper__content')}>
                                    ...
                                    <div className={cx('wrapper__content-text')}>
                                        ...
                                        <Link to="/manager/chat"><button className={cx('btn-chat')}>Chat With Seller</button></Link>
                                    </div>
                                </div>
                            </div>
                        </div>
